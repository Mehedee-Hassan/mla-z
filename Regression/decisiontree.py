"""
decision tree
: split data using entrophy
: terminal predict exactly which color / class
...
"""
# :: as decision tree is not a eucledian distance we don't need to do any feature scaling 
